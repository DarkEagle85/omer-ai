...
const welcomeMessage: ChatMessage = {
  role: "assistant",
  content:
    "Merhaba 👋 Ben Ömer AI. Sana nasıl yardımcı olabilirim?",
};
  ...
  async function loadProfile() {
    try {
      ...
      if (data.user) {
        ...
        setDailyLimit(
          data.user.dailyMessageLimit ||
            20
        );

        setUsedLimit(
          data.user.usedMessagesToday ||
            0
        );
      }
    } catch (error) {
        ...
        <footer className="border-t border-zinc-800 p-4">
          <div className="max-w-5xl mx-auto flex gap-3 items-end">
            <textarea
              ...
              rows={1}
              className="flex-1 bg-zinc-900 border border-zinc-700 rounded-xl p-4 outline-none min-w-0 disabled:opacity-60 resize-none overflow-hidden max-h-52"
            />
            ...
            {loading ? (
              <button
                ...
                className="bg-red-600 hover:bg-red-700 rounded-xl px-5 md:px-6 py-4 font-semibold"
              >
                Durdur
              </button>
            ) : (
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 rounded-xl px-5 md:px-6 py-4 font-semibold"
              >
                Gönder
              </button>
            )}
